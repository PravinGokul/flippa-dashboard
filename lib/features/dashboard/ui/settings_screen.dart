...
class SettingsScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(icon, color: color.withOpacity(0.9), size: 32),
            ),
  ...
  Widget _buildCurrencyTile(BuildContext context) {
    return BlocBuilder<GlobalBloc, GlobalState>(
      builder: (context, state) {
        return _buildTile(Icons.currency_exchange, "Currency", state.currency, Colors.indigo, () {});
      },
    );
  }
  ...
  Widget _buildDesktopCurrencyTile(BuildContext context) {
    return BlocBuilder<GlobalBloc, GlobalState>(
      builder: (context, state) {
        return _buildDesktopTile(Icons.currency_exchange, "Currency", state.currency, Colors.indigo, () {});
      },
    );
  }
